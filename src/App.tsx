...
const bibleVerses: BibleVerse[] = [
  ...
  { th: "เราเป็นทางนั้น เป็นความจริง และเป็นชีวิต ไม่มีใครมาถึงพระบิดาได้เว้นแต่มาทางเรา", kr: "내가 곧 길이요 진리요 생명이니 나로 말미암지 않고는 아버지께로 올 자가 없느니라", refTh: "(ยอห์น 14:6)", refKr: "(요 14:6)" },
